...
using StArray.Agents.Functions.SourceGenerator.Resources;
...
namespace StArray.Agents.Functions.SourceGenerator;
...
public class AgentToolParameterAnalyzer : DiagnosticAnalyzer
{
    ...
    {
        return compilation.GetTypeByMetadataName("StArray.Agents.Functions.Resources.Localization");
    }
        ...
        ImmutableArray<AttributeData> attributes, string name1, string name2)
    {
        return attributes.FirstOrDefault(attr =>
            ...
            && ac.ContainingNamespace?.ToDisplayString() == "StArray.Agents.Functions.Annotations");
    }
